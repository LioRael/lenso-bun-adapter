...
export const ENDPOINT_CONTRACT: CapabilityContractReference<EndpointClient> = { ...bindEndpointDependency(), capability_id: CAPABILITY_ID, descriptor_version: DESCRIPTOR_VERSION, descriptor_digest: DESCRIPTOR_DIGEST, generated_client: "EndpointClient" };

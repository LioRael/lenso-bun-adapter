...
export function bindAnonymousDependency(): CapabilityDependencyBinding<AnonymousClient, DependencyInvoker> {
  return {
    descriptor: {
      capability_id: CAPABILITY_ID,
      descriptor_version: DESCRIPTOR_VERSION,

...
export function bindAuthDependency(): CapabilityDependencyBinding<AuthClient, DependencyInvoker> {
  return {
    descriptor: {
      capability_id: CAPABILITY_ID,
      descriptor_version: DESCRIPTOR_VERSION,
